...
class CartPhotosResponse {
  ...
  CartPhotosResponse.fromJson(dynamic json) {
    ...
    if (json['data'] is List) {
      data = (json['data'] as List)
          .map((e) => CartPhotoData.fromJson(e))
          .toList();
    } else {
    ...
    if (json['deliveredPhotosDT'] is List) {
      deliveredPhotosDT = (json['deliveredPhotosDT'] as List)
    ...
    if (json['AccData'] is List) {
      accData = (json['AccData'] as List)
          .map((e) => AccData.fromJson(e))
          .toList();
    } else {
      accData = [];
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (deliveredPhotosDT != null) {
      map['deliveredPhotosDT'] = deliveredPhotosDT?.map((v) => v.toJson()).toList();
    }
    if (accData != null) {
